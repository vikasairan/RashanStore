...
public class Verify_mobile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP: {
                        ...
                        {
                            Toast.makeText(Verify_mobile.this, "Invalid OTP", Toast.LENGTH_SHORT).show();
        ...
        findViewById(R.id.resendcode).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Verify_mobile.this, "Verification Code Sent", Toast.LENGTH_SHORT).show();
                countDownTimer = new CountDownTimer(60000, 1000) {
                    @Override
                    public void onTick(long l) {
                        timer.setText("Please wait "+l/1000+" sec");
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        {
            Toast.makeText(Verify_mobile.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(Verify_mobile.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            Intent i=new Intent(Verify_mobile.this, ResetPassword.class);
                            ...
                            Toast.makeText(Verify_mobile.this, message, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
