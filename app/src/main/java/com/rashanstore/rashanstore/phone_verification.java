    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP: {
                        ...
                        {
                            Toast.makeText(phone_verification.this, "Invalid OTP", Toast.LENGTH_SHORT).show();
        ...
        findViewById(R.id.resendcode).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(phone_verification.this, "Verification Code Sent", Toast.LENGTH_SHORT).show();
                countDownTimer = new CountDownTimer(60000, 1000) {
                    @Override
                    public void onTick(long l) {
                        timer.setText("Please wait "+l/1000+" sec");
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if(type.equals("shopkeeper")) {
                                ...
                                Toast.makeText(phone_verification.this, "Account Successfully Created", Toast.LENGTH_SHORT).show();
                                intent = new Intent(phone_verification.this, Home.class);
                            ...
                            {
                                Toast.makeText(phone_verification.this, "Account Successfully Created", Toast.LENGTH_SHORT).show();
                                intent = new Intent(phone_verification.this, Customer.class);
                                startActivity(intent);
                                finish();
                            }
                        } else {
