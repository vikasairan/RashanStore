...
public class Contact extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_home:
                Intent h= new Intent(Contact.this,Home.class);
                startActivity(h);
                finish();
            ...
            case R.id.nav_account:
                Intent g= new Intent(Contact.this,profile.class);
                startActivity(g);
                finish();
                break;
            case R.id.nav_contact:
                Intent s= new Intent(Contact.this,Contact.class);
                startActivity(s);
                finish();
                break;
            case R.id.nav_terms:
                Intent t= new Intent(Contact.this,Terms.class);
                startActivity(t);
                finish();
                break;
            case R.id.logout:
